...
export default function SignUpBasic() {
  ...
  function handleSubmit(event) {
    ...
    if(formInfo.password === formInfo.passwordConfirmation){
      console.log('Tebrikler kayıt gerçekleşti')
    } else{
  ...
  return (
    <div className='container'>
      ...
      <hr />
      <svg className='icons' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 50 50">
      ...
      <p className='is-member'>Already a Member? <b>
